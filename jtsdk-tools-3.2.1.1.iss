...
#define MyAppName "JTSDK Tools 3.2.1.1"
#define MyAppVersion "3.2.1.1"
#define MyAppPublisher "(c) 2013 - 2022 Greg Beam KI7MT and JTSDK Contributors"
...
AppId={{23492739-2EF2-44AF-9437-50AC50CE9D0C}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-Tools-3.2.1.1
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.2.1.1
...
Type: files; Name: "{app}\tools\msys64\etc\skel\bin\build-hamlib-static.sh" 
Type: files; Name: "{app}\tools\msys64\etc\skel\bin\build-hamlib-dll.sh" 
Type: filesandordirs; Name: "{app}\tools\msys64\home\*"
