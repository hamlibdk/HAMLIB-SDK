...
#define MyAppName "JTSDK 3.2.0ab1"
#define MyAppVersion "3.2.0ab1"
#define MyAppPublisher "(c)2020 - 2021 JTSDK Contributors based on concepts and code 2013-2019 (c) Greg Beam KI7MT"
...
AppId={{DC205F33-3E1C-424D-B43B-9692CD48B9C8}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-All-3.2.0ab1
Compression=lzma
