...
#define MyAppName "JTSDK Tools 3.2.3.1"
#define MyAppVersion "3.2.3.1"
...
AppId={{AB323BC8-3E33-4CB6-B56F-14F1C72E7B2E}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-Tools-3.2.3.1
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.2.3.1
