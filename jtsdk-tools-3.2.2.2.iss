...
#define MyAppName "JTSDK Tools 3.2.2.2"
#define MyAppVersion "3.2.2.2"
...
AppId={{18223C73-1444-40EC-8385-ABAF01844B5E}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-Tools-3.2.2.2
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.2.2.2
