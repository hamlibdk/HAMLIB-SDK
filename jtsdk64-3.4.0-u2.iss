...
#define MyAppName "JTSDK64-3.4.0-U2"
#define MyAppVersion "3.4.0.2"
#define MyAppPublisher "(c)2020 - 2024 JTSDK Contributors based on concepts and code 2013-2021 (c) Greg Beam KI7MT"
#define MyAppURL "https://sourceforge.net/projects/hamlib-sdk/files/Windows/JTSDK-3.4-Stream/"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{686888AB-4DCB-438C-AA3B-DB7023EF1240}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-3.4.0-U2
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.4.0.2
...
Name: "{group}\Sourceforge Repository"; Filename: "https://sourceforge.net/projects/hamlib-sdk/files/Windows/JTSDK-3.4-Stream/"; WorkingDir: "{app}"
