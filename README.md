...
### Release Notes: Tools 3.2.2.1 Package

The [Tools 3.2.2.1](JTSDK64-Tools-3.2.2.1) package comprises of a number of updates centred on 
...
Also note that the **mingw32** environment is also aliased - and that may be exploed by 
...
************************************************************************************
**Note:** The current "Tools" package is  [JTSDK64-Tools-3.2.2.1.exe](JTSDK64-Tools-3.2.2.1).
************************************************************************************
...
************************************************************************************
The current "Tools" package [JTSDK64-Tools-3.2.2.1.exe](JTSDK64-Tools-3.2.2.1) does not delete the profile nor update [MSYS2][] scripts.
************************************************************************************
