...
Version 4 of the JTSDK will involve a number of strategic re-thinks. Watch the [JTSDK Forum][] for 
...
The section of the **Versions.ini** file where these keys are found are showb below:
