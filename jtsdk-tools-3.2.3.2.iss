...
#define MyAppName "JTSDK Tools 3.2.3.2"
#define MyAppVersion "3.2.3.2"
...
AppId={{F2EA91FC-C4B9-46E2-B108-144E7266E581}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-Tools-3.2.3.2
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.2.3.2
