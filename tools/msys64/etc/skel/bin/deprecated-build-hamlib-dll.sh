...
#                 Addition of runtime switches Steve I 8-9-2021
#                 Bug fixes and adjustments to better support DLL's in JT-ware Steve 1 3-1-2022
#
...
Package-Data () {
	...
	echo -e " Package ..............: ${C_G}$PKG_NAME - ${HL_FILENAME}"${C_NC}
	...
	echo -e " SRC Dir ..............: ${C_G}$HOME/${BUILD_BASE_DIR}"${C_NC}
	echo -e " Build Dir ............: ${C_G}$HOME/${BUILD_BASE_DIR}/$PACKVER/$PACKVER"${C_NC}
	echo -e " Uncompressed Output ..: ${C_G}$HOME/${BUILD_BASE_DIR}/$PACKVER/${HL_FILENAME}"${C_NC}
