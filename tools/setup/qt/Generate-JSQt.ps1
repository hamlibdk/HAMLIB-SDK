...
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.win64_mingw`"`)`;"
# Add-Content $of  " widget.selectComponent`(`"qt.tools.win64_mingw900`"`)`;"

Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qt5compat`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qt5compat.win64_mingw`"`)`;"

Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qt3d`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qt3d.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtactiveqt`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtactiveqt.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtactiveqt`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtactiveqt.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtcharts`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtcharts.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtconnectivity`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtconnectivity.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtdatavis3d`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtdatavis3d.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtimageformats`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtimageformats.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtlanguageserver`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtlanguageserver.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtlottie`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtlottie.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtmultimedia`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtmultimedia.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtnetworkauth`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtnetworkauth.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtpdf`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtpdf.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtpositioning`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtpositioning.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtremoteobjects`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtremoteobjects.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtscxml`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtscxml.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtsensors`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtsensors.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtserialbus`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtserialbus.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtserialport`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtserialport.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtvirtualkeyboard`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtvirtualkeyboard.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebchannel`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebchannel.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebengine`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebengine.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebsockets`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebsockets.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebview`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.addons.qtwebview.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.debug_info`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.debug_info.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtquick3d`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtquick3d.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtquicktimeline`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtquicktimeline.win64_mingw`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtshadertools`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.650.qtshadertools.win64_mingw`"`)`;"
