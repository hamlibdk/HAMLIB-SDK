...
Add-Content $of  " widget.selectComponent`(`"qt.qt5.51210.win64_mingw73`"`)`;"
Add-Content $of  " gui.clickButton`(buttons.NextButton`)`;"
Add-Content $of  "`}"
Add-Content $of  " "
...
Add-Content $of  " widget.selectComponent`(`"qt.qt5.51210.win64_mingw73`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt5.5142.win64_mingw73`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt5.5152.win64_mingw81`"`)`;"
Add-Content $of  " widget.selectComponent`(`"qt.qt6.601.win64_mingw81`"`)`;"
Add-Content $of  " gui.clickButton`(buttons.NextButton`)`;"
Add-Content $of  "`}"
Add-Content $of  " "
Add-Content $of  "Controller.prototype.LicenseAgreementPageCallback `= function`(`) `{"
