...
#
# Usage ........: Call this from jtsdk64-tools-setup => Install-Qt.ps1 $*
#
...
# License ......: GPLv3
#
# Conversion and logic refactoring Steve VK3SIR 25-27-Dec-2020 
#
#-----------------------------------------------------------------------------#
...
function InstallQt($script) {
	...
	Write-Host "-----------------------------------------------------"
	Write-Host " "
	Write-Host "NOTE: Some installer buttons are disabled for several "
	Write-Host "pages. To Cancel/Stop the installation, kill the Qt"
	Write-Host "Installer via the Windows Task Manager."
	Write-Host " "
...
function UpdateComponents {
	...
	$exitCode = Invoke-Command -ScriptBlock { cmd /c $cmd *> $null; return $LASTEXITCODE }
	# start $JTSDK_TOOLS\Qt\MaintenanceTool.exe ^-^-manage-packages
...
function InstallHelp {
	...
	Write-Host "        qt.qt6.00.win64_mingw81"
...
function InstallSummary {
	...
	Write-Host "-----------------------------------------------------"
	Write-Host " "
	Write-Host "JTSDK64 Tools Qt Installation Complete. The following"
	...
	if ($script -eq "full") {
		...
		Write-Host "    qt.qt5.5142.win64_mingw73"
		Write-Host "    qt.qt5.5152.win64_mingw73"
		Write-Host "    qt.qt5.600.win64_mingw81"
		Write-Host "    qt.tools.win64_mingw730"
		Write-Host "    qt.tools.win64_mingw810"
		Write-Host "    qt.tools.vcredist_msvc2017_x64"
	}
...
Write-Host "  full   - Scripted installation Qt 5.12.10, 5.14.2, 5.15.2, 6.0.0"
