...
#define MyAppName "JTSDK Tools 3.2.2.4"
#define MyAppVersion "3.2.2.4"
...
AppId={{6B7D043A-E4B5-4986-9CA6-EB18FCF09333}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-Tools-3.2.2.4
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=3.2.2.4
