...
#define MyAppName "JTSDK64 4.1.1/4.1.1.1 -> 4.1.1.2"
#define MyAppVersion "4.1.1.2"
#define MyAppPublisher "(c)2020 - 2026 JTSDK Contributors based on concepts and code 2013-2021 (c) Greg Beam KI7MT"
...
AppId={{55BD1E54-A5B7-4D7C-9F21-00CE1F79B0D4}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-4.1.1-U2
Compression=lzma
SolidCompression=yes
WizardStyle=modern
LicenseFile=C:\JTSDK64-Tools\gpl-3.0.rtf
VersionInfoVersion=4.1.1.2
...
; Type: filesandordirs; Name: "{app}\jtsdk64-tools\tools\subversion\*.*"
; Type: filesandordirs; Name: "{app}\jtsdk64-tools\tools\sqlite\*.*"
; Type: filesandordirs; Name: "{app}\jtsdk64-tools\tools\ruby\*.*"
Type: filesandordirs; Name: "{app}\jtsdk64-tools\tools\hamlib\*.*"
