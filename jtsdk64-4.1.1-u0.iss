...
#define MyAppName "JTSDK64 4.1.0 -> 4.1.1"
...
AppId={{F743C864-BD6E-4D14-A6C1-A475A1757FC5}
AppName={#MyAppName}
...
OutputBaseFilename=JTSDK64-4.1.1-U0
Compression=lzma
...
Type: filesandordirs; Name: "{app}\jtsdk64-tools\subversion\*.*"
Type: filesandordirs; Name: "{app}\jtsdk64-tools\sqlite\*.*"
Type: filesandordirs; Name: "{app}\jtsdk64-tools\ruby\*.*"
